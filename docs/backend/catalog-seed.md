...
Importer tidak membuat data sintetis, tidak menghapus produk/varian/media lain, dan tidak mengaktifkan Biteship atau Midtrans. `stockOnHand`, harga, SKU, dan foto harus berasal dari dataset Owner; key foto harus sudah dipetakan ke asset production yang aman untuk publik. Publikasi tetap melewati editor admin dan gate bukti/izin.
