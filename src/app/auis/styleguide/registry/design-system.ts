...
export const designSystemMeta = {
  ...
  productScreenProofVisualAcceptanceAt: "2026-09-22",
  productScreenProofAcceptanceScope: "Owner accepted the named previews for / and /project-brief; no global product-screen propagation",
