...
export const designSystemMeta = {
  ...
  productScreenPropagationAllowed: true,
  productScreenPropagationDecision: "DS-DEC-019-DESIGN-SYSTEM-FOUNDATION-PROPAGATION",
  productScreenPropagationMode: "global-foundation-typography-authorized",
  productScreenPropagationScope: ["foundation", "typography"],
  productScreenProofRoutes: ["/", "/project-brief"],
  productScreenProofStatus: "authorized-proof",
  productScreenProofTechnicalEvidence: "verified",
  productScreenProofEvidenceDoc: "docs/frontend/product-route-proof.md",
  productScreenProofEvidenceTest: "tests/e2e/product-route-proof.spec.ts",
  productScreenProofViewports: [320, 390, 768, 1280],
  productScreenProofVisualAcceptance: "approved-owner",
  productScreenProofVisualAcceptanceAt: "2026-09-25",
  productScreenProofAcceptanceScope: "Owner accepted the named previews for / and /project-brief on 2026-09-22 and accepted the 2026-09-25 post-remediation revalidation across 320/390/768/1280, including the build-only homepage media fallback and the 20px confidentiality checkbox with a clickable label; DS-DEC-019 authorizes Foundation/Typography globally without expanding visual acceptance or Official component promotion",
...
export const designSystemGuardrails = [
  ...
  "Global product-screen propagation is authorized only for Foundation/Typography v1.0 by DS-DEC-019; P0/P1 components, Motion, Patterns, Creative, and Decorative layers retain their existing gates.",
] as const;
