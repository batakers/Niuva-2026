...
export function PublicShell({ children, scope }: { children: ReactNode; scope: string }) {
  return (
    <div className={`${sans.variable} ${editorial.variable} min-h-screen bg-background text-foreground`}
      ...
      data-product-screen-functional={["cart", "checkout", "custom-print", "custom-request", "product-detail", "project-brief", "quote-review", "shop"].includes(scope) ? "frontend-preview" : undefined}>
